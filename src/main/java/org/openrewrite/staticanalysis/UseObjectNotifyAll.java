...
public class UseObjectNotifyAll extends Recipe {
    ...
    public String getDescription() {
        return """
               `Object.notifyAll()` and `Object.notify()` both wake up sleeping threads, but `Object.notify()` only rouses one while `Object.notifyAll()` rouses all of them. \
    ...
    public Set<String> getTags() {
        return Collections.singleton("RSPEC-S2446");
    }
