        ...
        return new JavaIsoVisitor<ExecutionContext>() {
            ...
            private String numericVariableName(Statement s) {
                if (s instanceof J.Assignment assignment) {
                    ...
                    J.VariableDeclarations.NamedVariable firstNamedVariable = declarations.getVariables().getFirst();
            ...
            private Statement combine(Cursor cursor, String op, Expression right) {
                ...
                if (s instanceof J.Assignment assign) {
                    ...
                    J.Assignment after = combinedAssignment.apply(cursor, s.getCoordinates().replace(), variables.getVariables().getFirst().getInitializer(), op, right);
